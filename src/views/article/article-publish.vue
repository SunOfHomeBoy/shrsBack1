        ...
        <Card>
          ...
          <div class="height-120px">
            <Row type="flex" justify="center" align="middle" class="height-100">
              <Upload name="photos" action="http://127.0.0.1:10007/service/upload/imgUpload" accept="image/*" :format="['jpg', 'png', 'jpeg', 'gif', 'bmp', 'svg']" :on-format-error="handleFormatError" :on-success="uploadSuccess" :before-upload="beforeUpload">
                <span>选择图片上传&nbsp;&nbsp;</span>
